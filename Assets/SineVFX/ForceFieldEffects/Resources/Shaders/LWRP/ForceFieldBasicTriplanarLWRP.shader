	...
	SubShader
	{
		...
		Pass
		{
				...
				, bool ase_vface : SV_IsFrontFace )
			{
				...
				#endif
				float2 uv_MaskAppearNoise = IN.ase_texcoord6.xy * _MaskAppearNoise_ST.xy + _MaskAppearNoise_ST.zw;
				float4 triplanar303 = TriplanarSampling303( _MaskAppearNoise, ase_worldPos, IN.normalWS, 1.0, _MaskAppearNoiseTriplanarTiling, 1.0, 0 );
				#ifdef _MASKAPPEARNOISETRIPLANAR_ON
				float staticSwitch304 = triplanar303.x;
				#else
				float staticSwitch304 = tex2D( _MaskAppearNoise, uv_MaskAppearNoise ).r;
...
ASEEND*/
//CHKSM=21A133B37B6AC2F7F3212F04DD9F26FB7DD77A30